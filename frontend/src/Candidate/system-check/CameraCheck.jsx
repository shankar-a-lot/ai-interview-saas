...
const CameraCheck = ({ status, isChecking }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h3 className="font-semibold text-white text-lg">Camera Access</h3>
          <p className="text-sm text-gray-300 mt-1">Ensure your camera is working properly</p>
        </div>
      </div>
...
export { CameraCheck, checkCamera };
